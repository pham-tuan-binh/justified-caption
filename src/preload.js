...
contextBridge.exposeInMainWorld('api', {
  ...
  beginExport: (opts) => ipcRenderer.invoke('export:begin', opts),
  writeExportFrame: (payload) => ipcRenderer.invoke('export:write-frame', payload),
  endExport: (payload) => ipcRenderer.invoke('export:end', payload),
